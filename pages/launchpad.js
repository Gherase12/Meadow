...
function Launchpad() {
  ...
  return (
    <PageAnimation>
      <div className='border-2 lg:h-[947.31px]  overflow-hidden   w-full flex md:max-w-[1440px]   overflow-x-hidden  md:space-x-[62px] mx-auto my-auto  '>
        <div className='    w-full md:mb-[11px] relative px-[30px]  md:px-0  '>
          ...
          <ul className='mb-[21px] items-center font-avenir font-black leading-[24px] h-[38px] lg:w-[368px] flex justify-between '>
            {filters.map((l, i) => (
              <li key={i}>{l}</li>
            ))}
          </ul>
