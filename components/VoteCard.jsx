  ...
  return (
    <div className='relative w-full mb-[70px]  lg:w-[591.99px]  lg:h-[310.52px] bg-white rounded-[30px] lg:py-[32px] lg:px-[30px] card1  '>
      ...
      <div className='absolute  left-0 -top-[47px] w-full  lg:hidden   flex justify-between  mb-[35px]'>
        <div className='w-[208px] h-[24px] font-extrabold text-[22px] leading-[24px] '>Upcoming Games</div>
      ...
      <div className='hidden   lg:flex justify-between  mb-[35px]'>
        <h2 className='w-[208px] h-[24px] font-extrabold text-[22px] leading-[24px] '>Upcoming Games</h2>
