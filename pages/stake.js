  ...
  return (
    <div className='lg:h-[947.31px]   z-30  w-full flex md:max-w-[1440px]  pr-0 overflow-hidden md:space-x-[62px] mx-auto my-auto relative  font-avenir lg:items-center justify-center '>
      ...
      <div className=' z-30 flex flex-col justify-center  items-center pb-[100px] '>
        <div className='px-[10px]  text-[32px] lg:text-[41px] font-black leading-[32px] lg:leading-[51px] mb-[22px] text-center '>
          Stake coming soon
        </div>
        <div className='px-[10px]  z-30 text-[14px] lg:text-[16px] text-center w-[325px] lg:w-[572px] mb-[51px]  '>
        ...
        <div className='px-[10px]  text-[14px] lg:text-[15px] text-center font-black  mb-[22px] h-[44px]  w-[319px]  lg:w-[396.86px]'>
