...
function VotingMobile({projects, isLoading}) {
  return (
    <div className="h-[240px] mb-[150px] md:hidden " >
        {/* upper section */}
         <div className='w-full flex justify-between mb-[13px]'>
        <div className='w-[208px] h-[24px] font-extrabold text-[22px] leading-[24px] '>Vote for projects</div>
      ...
      { !isLoading ? projects.slice(0, 3).map(({ id, name, img, website, votes, twitter, discord }, i) => (
